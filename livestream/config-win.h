...
#define FFMPEG_CONFIGURATION "--disable-autodetect --disable-avdevice --disable-doc --disable-programs --disable-protocols --disable-static --enable-asm --enable-bzlib --enable-openssl --enable-protocol=file --enable-protocol=rtp --enable-protocol=srtp --enable-shared --enable-version3 --enable-x86asm --enable-zlib --arch=x86_64 --cpu=ivybridge --toolchain=msvc --windres=windres --ar=llvm-lib --cc=clang-cl --cxx=clang-cl --ld=lld-link --enable-d3d11va --enable-dxva2 --extra-ldflags='-LIBPATH:\"C:/Users/user/tmp/FFmpeg/bzip2-ins/lib\"' --extra-ldflags='-LIBPATH:\"C:/Users/user/studio/depends/openssl/lib/win\"' --extra-ldflags='-LIBPATH:\"C:/Users/user/studio/depends/zlib/lib/win\"' --enable-optimizations --extra-ldflags='-DEBUG -OPT:ICF -OPT:REF' --extra-cflags='-clang:-fasm-blocks' --extra-cxxflags='-clang:-fasm-blocks' --extra-cflags='-clang:-fgnu-inline-asm' --extra-cxxflags='-clang:-fgnu-inline-asm' --extra-cflags='-clang:-Wundef' --extra-cxxflags='-clang:-Wundef' --extra-cflags='-I\"C:/Users/user/tmp/FFmpeg/bzip2-ins/include\"' --extra-cxxflags='-I\"C:/Users/user/tmp/FFmpeg/bzip2-ins/include\"' --extra-cflags='-I\"C:/Users/user/studio/depends/openssl/include\"' --extra-cxxflags='-I\"C:/Users/user/studio/depends/openssl/include\"' --extra-cflags='-I\"C:/Users/user/studio/depends/zlib/include\"' --extra-cxxflags='-I\"C:/Users/user/studio/depends/zlib/include\"' --extra-cflags=-wd4090 --extra-cxxflags=-wd4090 --extra-cflags=-wd4101 --extra-cxxflags=-wd4101 --extra-cflags=-wd4114 --extra-cxxflags=-wd4114 --extra-cflags=-wd4267 --extra-cxxflags=-wd4267 --extra-cflags=-wd4334 --extra-cxxflags=-wd4334 --extra-cflags=-O2 --extra-cxxflags=-O2 --extra-cflags=-MD --extra-cxxflags=-MD --prefix=/c/Users/user/tmp/FFmpeg/ins-x64"
#define FFMPEG_LICENSE "LGPL version 3 or later"
#define CONFIG_THIS_YEAR 2022
#define FFMPEG_DATADIR "/c/Users/user/tmp/FFmpeg/ins-x64/share/ffmpeg"
#define AVCONV_DATADIR "/c/Users/user/tmp/FFmpeg/ins-x64/share/ffmpeg"
#define CC_IDENT "clang version 14.0.5"
